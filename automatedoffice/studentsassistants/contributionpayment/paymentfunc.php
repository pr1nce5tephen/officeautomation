																	...
																	echo"
																		<tr align='center'>
																			...
																			if($fetchquery = mysql_fetch_assoc($query)){
																				echo"
																					<td><a style='text-decoration:none;' href='paymentfunc.php?unpay&add=$contribID&amount=$amount&studID=$fetchstudent[control_number]'><input type='button' name='unpay' value='PAID' disabled/></a></td>
																				";
																			}
																			else
																			{
																				echo"
																					<td><a style='text-decoration:none;'  href='paymentfunc.php?pay&add=$contribID&amount=$amount&studID=$fetchstudent[control_number]'><input type='button' name='pay' value='PAY' /></a></td>
																				";
																			}
																}
