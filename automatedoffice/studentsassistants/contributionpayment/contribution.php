								...
								while($data = mysql_fetch_assoc($query)) {
									...
									echo "<tr>
										 ...
										 echo"		
										  ...
										  <td align = center><a style='text-decoration:none;' href = 'paymentfunc.php?add=$data[contribID]&amount=$data[contribAmount]'><input type='button' name='pay' value='Payment' /></a></td> ";
