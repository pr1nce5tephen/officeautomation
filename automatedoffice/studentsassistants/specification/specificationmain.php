...
<td><a href="updatespecification.php?specification_id=<?php echo $rows['specification_id']?>"><img src="../images/b_edit.png"></img></a></td>
<td><a href="specificationdelete.php?specification_id=<?php echo $rows['specification_id']?>" onclick="return confirm('are you sure you want delete this record!')"><img src="../images/b_drop.png"></img></a></td>
</tr>
<?php
}
?>
...
<br/>
<a style="text-decoration:none;" href='specificationadd.php'/><input type="button" value="ADD"/></a>
</div>
</center>
<p><h2>&nbsp;</h2> 
		</p>
