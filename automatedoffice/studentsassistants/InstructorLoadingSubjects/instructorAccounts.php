...
echo "<meta http-equiv = 'refresh' content='0; url=instructormain.php' />";
 ...
 if(isset($_REQUEST['update'])) {
	...
	mysql_query("UPDATE faculty SET lname='$lname', fname='$fname', mi='$mi', address='$address', gender='$gender', contactno='$contactno', rate='$rate', position='$position', status='$status', teaching_type='$teaching_type' WHERE fcode='$id' ");
