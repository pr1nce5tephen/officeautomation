...
$c=mysql_query("SELECT count(DISTINCT bscheds.section_id) FROM bscheds WHERE course_id='$parent_cat' AND yrlvl='$sub_cat' AND sem='$sem' AND sy_id='$sy_id' ");
...
echo"<center><br/><br/><br/><br/><br/><br/><span style='width:20%;text-align:center; color:red;'>";
  if($count > 0)
  {
    ...
    ?>
    <br/><br/>
    <a href="schedules2.php?parent_cat=<?php echo $parent_cat ?>&&sub_cat=<?php echo $sub_cat ?>&&section=<?php echo $section ?>&&section2=<?php echo $section ?>&&sem=<?php echo $sem ?>"><button>Yes</button></a>
  ...
  {
    echo"<meta http-equiv='refresh' content='0; url=schedules.php?parent_cat=$parent_cat&&sub_cat=$sub_cat&&section=$section&&sem=$sem'>";
  }
} 
	 ?>