...
if(isset($_REQUEST['find']))
{
  ...
  {
$result = mysql_query("SELECT * FROM bscheds,rooms,subject,course,sy WHERE bscheds.room_id=rooms.room_id AND bscheds.subject_id=subject.subject_id AND bscheds.course_id=course.course_id AND bscheds.sy_id=sy.sy_id AND sy.sy_stat='active' AND bscheds.course_id='$course' AND bscheds.yrlvl='$yrlvl' AND bscheds.sem='$sem' AND bscheds.sy_id='$sy' ORDER BY bscheds.section_id ASC");
