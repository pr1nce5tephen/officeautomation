...
<?php
 ...
 mysql_query("INSERT INTO bscheds(`sched_id`,`subject_id`,`course_id`,`yrlvl`,`in`,`out`,`type`,`section_id`,`room_id`,`size`,`pop`,`sy_id`,`sem`,`status`) VALUES('','$subid','$course','$yrlvl','$in','$out','$row[type]','$v','$getroom[room_id]','$getrsize[room_size]','0','$getsy[sy_id]','$sem','not full')");    
  $schedid=mysql_insert_id();
