...
$subject=mysql_query("SELECT * FROM subject WHERE subject_id='$sid'");
$getsub=mysql_fetch_array($subject);
$sspec=$getsub['subject_specification'];
    ...
    <tr>
      ...
      <td>
        <select name="rid">
          ...
          <?php 
            $r=mysql_query("SELECT * FROM rooms,specification WHERE NOT EXISTS (SELECT * FROM schedules WHERE rooms.room_id=schedules.room_id) AND rooms.room_specification=specification.specification_id AND specification.specification='$sspec' AND room_id != '$getroom[room_id]'");
