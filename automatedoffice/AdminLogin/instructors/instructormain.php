								...
								<tr>
									...
									if($status == 'active'){
										echo "<form action='instructorAccounts.php' method='POST' >
											...
											<input class='button' type='submit' name='instructor_stat' value='$msg' />
											</form>";
									}
									else{
										echo "<form action='instructorAccounts.php' method='POST' >
...
++$i;
	  ...
	  <div align='center'class='menu_nav3'>
								...
								<a style="text-decoration:none;" href='addinstructor.php'/><input class='button' type="button" value="Add instructor"/></a>
