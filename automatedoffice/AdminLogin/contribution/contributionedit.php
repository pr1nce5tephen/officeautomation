					...
					<?php	
							...
							if(isset($_REQUEST['edit'])){
								...
								echo" 
									...
									<table class='menu_tab2' rules='all' width='30%'  border='1'>
										...
										echo"
										<tr>
											<td colspan = '2' align='center'><input class='button' type = 'submit' name = 'update' value = 'UPDATE' ></td>
										</tr>
										</table>
										</form>";
							...
							if(isset($_REQUEST['update2'])){
								...
								if(isset($_POST['classID']))
								{
									...
									mysql_query("DELETE from studentcontribution where contribID='$contribID'");
									mysql_query("UPDATE contribution SET contribDesc = '$contribDesc', contribAmount = 'P$contribAmount.00', contribSem = '$contribSem', contribYear = '$contribYear', status = '$status' WHERE contribID='$contribID'") or die (mysql_error());
