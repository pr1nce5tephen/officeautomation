				...
				<?php include('../../menu/nav2.php');?>
					...
					<br>
						...
						<form action='contributionedit.php' method='POST'>
							...
							<input class='button' type='submit' name="submitSearch" value='Search' />
						</form>
						</center>
						<br />
							...
							<?php
								...
								while($data = mysql_fetch_assoc($query)) {
									...
									echo "<tr>
										 ...
										 echo"		
										 <td align = center><a href = 'contributionedit.php?edit=$data[contribID]' title = 'Edit Contribution'><button class='button'>Edit</button></a></td>";
					...
					<center/>
						<ul>
							<li>
								<a href='contributionedit.php?add'><button class='button'>Add</button></a>
							</li>
						</ul><br/>
			<footer>
			<div class="section">
