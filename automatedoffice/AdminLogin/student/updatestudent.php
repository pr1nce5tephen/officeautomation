...
<table class='menu_tab2' rules="all" width="40%"  border="1">
  ...
  <tr>
	...
	<tr>
		<tr></tr><tr></tr>
		<tr><td colspan="2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class='button' type = "submit" name = "btnsave" value = "update">&nbsp;&nbsp;&nbsp;&nbsp;<input class='button' type="reset" name="reset" value="reset"/></td></tr>
	</tr>
	  ...
	  <div align='center'class='menu_nav3'>
								...
								<a style="text-decoration:none;" href='studentmain.php'/><input class='button' type="button" value="Back"/></a>
