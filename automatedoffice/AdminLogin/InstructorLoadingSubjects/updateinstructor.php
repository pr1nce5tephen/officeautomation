...
<table class='menu_tab2' rules="all" width="30%"  border="1">
	...
	<tr>
		<td>Lastname:</td>
		<td><input type="text" name="lname" value="<?php echo $data ['lname'] ?>" size="30px" onkeyup="checkInputa(this)"  /></td>
	</tr>
	
	<tr>
		<td>Firstname:</td>
		<td><input type="text" name="fname" value="<?php echo $data ['fname'] ?>"  size="30px" onkeyup="checkInputa(this)"  /></td>
		
	</tr>
	
	<tr>
		<td>Middle Initial</td>
		<td><input type="text" name="mi" value="<?php echo $data ['mi'] ?>"  size="30px" onkeyup="checkInputdot(this)"  /></td>
	</tr>
	
	<tr>
		<td>Address</td>
		<td><textarea name="address" onkeyup="checkInput(this)" ><?php echo $data ['address'] ?></textarea></td>
	</tr>
	...
	<tr>
		<td>Contact Number:</td>
				<td><input name="contactno" onkeyup2="checkInput(this)"   value="<?php echo $data ['contactno'] ?>" ></td>
	</tr>
	
	<tr>
		<td>Rate</td>
		<td><input name="rate" onkeyup="checkInputdot(this)"  value="<?php echo $data ['rate']?>" ></td>
	</tr>
	...
	<tr>
		<td>Status</td>
		<td><input name="status"  value="<?php echo $data ['status'] ?>"/></td>
	...
	<tr>
		<tr></tr><tr></tr>
		<tr><td colspan="2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type = "submit" name = "update" value = "update">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="reset"/></td></tr>
	</tr>
