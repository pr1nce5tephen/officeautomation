...
check_level();
 	$room_code=$_REQUEST['room_code'];
 	 $queryroom = mysql_query("SELECT * FROM rooms where room_code = '$room_code'");
...
<head> 
 ...
 <form method="post" action="">
 	...
 	<tr><td><input type="text" name="room_size" placeholder="input room size" onkeyup="checkInput2(this)"  /></td></tr>
