...
while($rows=mysql_fetch_array($result))	{
	...
	$msg = $stat == 'Available' ? 'Available': 'Not Available';
		...
		if($msg == 'Available'){
				echo"<form action='process.php' method='post'>
						...
						<td><input class='button' type='submit' name='room_stat' value='$msg' /></td>
					 </form>";
		}else{
				echo"<form action='process.php' method='post'>
						<input type='hidden' name='room_id' value='$room_id' />
		...
		<td><a href="updateroom.php?room_id=<?php echo $room_id?>"><img class='button' src="../images/b_edit.png"></img></a></td>
		<td><a href="deleteroom.php?room_id=<?php echo $room_id?>" onclick="return confirm('are you sure you want to delete this data?')"><img class='button' src="../images/b_drop.png"></img></a></td>
		</tr>
	...
	<?php }++$i;?>
	  ...
	  <div align='center'class='menu_nav3'>
								...
								<a style="text-decoration:none;" href='addroom.php'/><input class='button' type="button" value="ADD"/></a>
