...
if($rows['years'] != null && $rows['months'] != null)
		...
		if($stat == 'Offered'){
										echo "<form action='process.php' method='POST' >
											...
											<td><input class='button' type='submit' name='course_stat' value='$stat' /></td>
											</form>";
									}
									else{
										echo "<form action='process.php' method='POST' >
...
<td><a href="updatecourse.php?course_id=<?php echo $course_id?>"><img class='button' src="../images/b_edit.png"></img></a></td>
<td><a href="deletecourse.php?course_id=<?php echo $course_id?>" onclick="return confirm('are you sure you want to delete this data?')"><img class='button' src="../images/b_drop.png"></img></a></td>
</tr>
<?php
	 ++$i;
	}
	?>
	  ...
	  <div align='center'class='menu_nav3'>
								...
								<a style="text-decoration:none;" href='courseadd.php'/><input class='button' type="button" value="ADD"/></a>
