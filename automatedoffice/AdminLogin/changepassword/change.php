...
<html>
	...
	<body>
						...
						<table class="menu_tab2" rules="all" >
							...
							<form method='POST' action ='change.php'>
										<center>
											...
											<td colspan = '2' align='center'><input class="button" type = 'submit' name = 'update' value = 'Change Password' ></td>
												</tr>
										</form>
						</table>
						</form>
					...
					<center>
						<ul>
							<li>
								<a href= '../users/usermain.php'><button class="button" >Back</button></a>
							</li>
						</ul><br/>
